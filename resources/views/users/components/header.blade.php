                        ...
                        <div class="full-setting-area">
                            <div class="top-dropdown">
                                <ul>
                                    ...
                                    <li class="drodown-show"><span>Language:</span> <a href="#"><img src="{{url('/frontend')}}/img/icon/p-1.jpg" alt=""> English <i class="fa fa-angle-down"></i></a>
                                        <ul class="open-dropdown">
                                            <li><a href="#"><img src="{{url('/frontend')}}/img/icon/p-1.jpg" alt=""> English</a></li>
                                            <li><a href="#"><img src="{{url('/frontend')}}/img/icon/p-2.jpg" alt=""> Français</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <ul class="shopping-cart-wrapper">
                                        <li>
                                            <div class="shoping-cart-image">
                                                <a href="#">
                                                    <img src="{{url('/frontend')}}/img/small-product/1.jpg" alt="">
                                        ...
                                        <li>
                                            <div class="shoping-cart-image">
                                                <a href="#">
                                                    <img src="{{url('/frontend')}}/img/small-product/2.jpg" alt="">
                                                    <span class="product-quantity">1x</span>
                                                </a>
                                            </div>
                                            <div class="shoping-product-details">
