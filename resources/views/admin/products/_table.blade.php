    ...
    <div class="table-responsive">
        ...
        <table id="productTable" class="table table-striped table-hover" style="width: 100%">
            ...
            <tr>
                ...
                <th scope="col" width="3%" class="sort-link position-relative" data-sort="id" style="cursor: pointer;">
                    #
...
{{--                    </a>--}}
                ...
                <th scope="col" width="10%" class="sort-link position-relative" data-sort="price" style="cursor: pointer;">
...
{{--                    </a>--}}
                ...
                <th scope="col" width="10%" class="sort-link position-relative" data-sort="productCategory" style="cursor: pointer;">
...
{{--                    </a>--}}
                ...
                <th scope="col" width="10%" class="sort-link position-relative" data-sort="brand" style="cursor: pointer;">
...
{{--                    </a>--}}
                ...
                <th scope="col" width="12%" class="sort-link position-relative" data-sort="created_at" style="cursor: pointer;">
