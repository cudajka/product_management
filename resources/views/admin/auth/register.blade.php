                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{route('admin.register.post')}}" class="row g-3" novalidate>
                                        @csrf
                                        <div class="col-12">
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" id="yourPasswordConfirmation" required>
